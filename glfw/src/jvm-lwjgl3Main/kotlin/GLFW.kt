...
) = GLFW.glfwSetMonitorUserPointer(
    monitor, pointer
)

actual inline fun glfwGetMonitorUserPointer(
    monitor: GLFWMonitor
) = GLFW.glfwGetMonitorUserPointer(
    monitor
)
...
actual inline fun glfwRequestWindowAttention(
    window: GLFWWindow
) = GLFW.glfwRequestWindowAttention(
    window
)
...
) = GLFW.glfwSetWindowUserPointer(
    window, pointer
)

actual inline fun glfwGetWindowUserPointer(
    window: GLFWWindow
) = GLFW.glfwGetWindowUserPointer(
    window
)
...
) = GLFW.glfwSetJoystickUserPointer(
    jid, pointer
)

actual inline fun glfwGetJoystickUserPointer(
    jid: Int
) = GLFW.glfwGetJoystickUserPointer(
    jid
)
...
actual inline fun glfwUpdateGamepadMappings(
    string: String
) = GLFW.glfwUpdateGamepadMappings(
    string
)

actual inline fun glfwGetGamepadName(
    jid: Int
) = GLFW.glfwGetGamepadName(
    jid
)
