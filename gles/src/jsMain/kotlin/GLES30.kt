...
actual inline fun GLES30.glGetBufferSubData(
    ...
    getBufferSubData(
        target, srcByteOffset.toInt(), buffer, dstOffset.toInt(), length.toInt()
    )
}
...
actual inline fun GLES30.glInvalidateSubFramebuffer(
    ...
    target, attachments.asDynamic(), x, y, width, height
)
...
actual inline fun GLES30.glGetInternalformativ(
    ...
    params, getInternalformatParameter(
...
actual inline fun GLES30.glBeginQuery(
    ...
    target, query.obj.unsafeNotNull()
)
...
actual inline fun GLES30.glGetSamplerParameteriv(
    ...
    params, getSamplerParameter(
        sampler.obj.unsafeNotNull(), pname
    )
)
...
actual inline fun GLES30.glClientWaitSync(
    ...
    sync.obj.unsafeNotNull(), flags, timeout.toLong().toDouble()
)

actual inline fun GLES30.glWaitSync(
    sync: GLSync, flags: GLbitfield, timeout: GLint64
) = waitSync(
    sync.obj.unsafeNotNull(), flags, timeout.toDouble()
)
...
actual inline fun GLES30.glGetSynciv(
    ...
    values, getSyncParameter(
        sync.obj.unsafeNotNull(), pname
    )
)

actual inline fun GLES30.glCreateTransformFeedback(
) = createTransformFeedback(
).toGLTransformFeedback()
...
actual inline fun GLES30.glTransformFeedbackVaryings(
    ...
    program.obj.unsafeNotNull(), varyings, bufferMode
)
...
actual inline fun GLES30.glBindBufferRange(
    ...
    target, index.toInt(), buffer.obj, offset.toInt(), size.toInt()
)
...
actual inline fun GLES30.glGetUniformIndices(
    ...
    val array = getUniformIndices(
        program.obj.unsafeNotNull(), uniformNames
    ) ?: return
    for (i in array.indices) {
        uniformIndices[i] = array[i].toUInt()
    }
}
...
actual inline fun GLES30.glGetActiveUniformsiv(
    ...
    params, getActiveUniforms(
        program.obj.unsafeNotNull(), uniformIndices.asIntArray().asDynamic(),
        pname
    )
)
...
actual inline fun GLES30.glGetUniformBlockIndex(
    ...
    program.obj.unsafeNotNull(), uniformBlockName
).toUInt()
...
actual inline fun GLES30.glGetActiveUniformBlockiv(
    ...
    params, getActiveUniformBlockParameter(
        program.obj.unsafeNotNull(), uniformBlockIndex.toInt(), pname
    )
)
...
actual inline fun GLES30.glGetActiveUniformBlockName(
    ...
    program.obj.unsafeNotNull(), uniformBlockIndex.toInt()
)
...
actual inline fun GLES30.glUniformBlockBinding(
    ...
    program.obj.unsafeNotNull(), uniformBlockIndex.toInt(),
    uniformBlockBinding.toInt()
)

actual inline fun GLES30.glCreateVertexArray(
) = createVertexArray(
).toGLVertexArrayObject()
